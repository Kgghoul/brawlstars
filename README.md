...
🌐 **Live Demo**: [https://kgghoul.github.io/brawlstars/](https://kgghoul.github.io/brawlstars/)  
📊 **API Documentation**: [http://91.229.11.191:8080/swagger/index.html](http://91.229.11.191:8080/swagger/index.html)  
🤖 **Telegram Bot**: [@primerbaotbot](https://t.me/primerbaotbot)

## 🎮 Возможности

- **Angular Web App** - современный интерфейс для просмотра аналитики (развернут на GitHub Pages)
- **Telegram Bot** - бот с WebApp интеграцией для быстрого доступа к статистике
- **Real API Integration** - подключение к реальному Brawl Stars API
- **Аналитика игроков** - статистика бойцов, винрейт, карты и режимы
- **Графики и визуализация** - интерактивные графики прогресса
- **Docker Support** - готовые конфигурации для развертывания

## 🚀 Быстрый старт

### Angular Web App (локально)
...
### Или используйте развернутое приложение

Просто откройте в браузере: https://kgghoul.github.io/brawlstars/
...
cp env.example .env
# Отредактируйте .env и укажите свой BOT_TOKEN

# Запустите бота
python bot.py
```

Бот автоматически подключится к реальному API: `http://91.229.11.191:8080`
